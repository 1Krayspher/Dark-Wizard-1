...
let ImgBlackjack =
  "https://lh3.googleusercontent.com/proxy/Pwi71Fw8yj5QENd2Sdq5lLHGG4Y4IEsRAm9Mj-k_V22tWXEwcyaJWi9Ld48YAQZWe8Eyw6XMfsYaiwOvWd7YnPySnTab58lHihNgnFcNyYJBiHPCp1nkLLpM2IUCMCvf7YA3wHfaHVGY8L1ApKZihDYM9vNHsfHTcTx5";
module.exports = {
  name: "blackjack",
      ...
      if (hit) {
        ...
        if (this.player.bust()) {
          let s = new Discord.RichEmbed()
            .setTitle(client.user.username + ` BlackJack`)
            .setDescription("Você perdeu **" + require("currency-formatter").format(quantidade, { code: "de-DE", symbol: "R$ ", precision: 0}) + "**")
            .setColor("#ff0101")
            .addField(
              `**🧟 ${message.author.username}**`,
              this.player.toString() +
        ...
        while (
          ...
          if (this.dealer.bust()) {
            s = new Discord.RichEmbed()
              .setTitle(client.user.username + ` BlackJack`)
              .setDescription("Você ganhou **" + require("currency-formatter").format(quantidade, { code: "de-DE", symbol: "R$ ", precision: 0}) + "**")
              .setColor("#01ff45")
              .addField(
                `**🧟 ${message.author.username}**`,
                this.player.toString() +
